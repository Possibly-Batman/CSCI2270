...
int main()
{
    ...
    cout << "I have no clue what causes this segfault. Or where this 16 comes from. I am flabberghasted." << endl;
    cout << "Seriously, ctrl + f for 16. It doesn't exist anywhere. My insert has no way of changing the key as well." << endl;
