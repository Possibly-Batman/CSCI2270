	...
	if(data.is_open())
	{
		while(getline(data, temp))
		{
			...
			if(numOfElement == capacity)
			{
				...
				arrayPtr = resize(arrayPtr, capacity);//I don't understand my troubles here. I've done it plenty when making pointers to arrays on the heap. Whatever, I need sleep
			}
